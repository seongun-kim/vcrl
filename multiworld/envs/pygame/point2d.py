...
from multiworld.envs.env_util import grid_to_wall
...
class Point2DEnv(MultitaskEnv, Serializable):
    ...
    def set_goal(self, goal):
        self.fixed_goal = goal['state_desired_goal']
    ...
    def render(self, mode='human', close=False):
        ...
        img = self.draw(self.render_drawer)
...
#############
"""
            self.walls = grid_to_wall(grid, self.boundary_dist, self.ball_radius, self.wall_thickness)

        if wall_shape == 'maze-b':
            grid = \
"""
#############
#S          #
