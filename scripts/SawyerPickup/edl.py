...
def train_policy(args):
    ...
    presampled_goals = variant['edl_variant']['generate_goal_dataset_fctn'](
        env=vae_env,
        env_id=variant.get('env_id', None),
        **variant['edl_variant']['goal_generation_kwargs']
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_id', default='SawyerPickupEnvYZEasy-v0', type=str, help='')
