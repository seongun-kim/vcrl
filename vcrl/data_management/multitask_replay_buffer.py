...
from vcrl.data_management.simple_replay_buffer import (
    SimpleReplayBuffer as VCRLSimpleReplayBuffer
)
...
class MultiTaskReplayBuffer(object):
    def __init__(
        ...
        self.task_buffers = dict([(idx, VCRLSimpleReplayBuffer(
    ...
    def create_new_task_buffer(self, task_idx):
        ...
        new_task_buffer = VCRLSimpleReplayBuffer(
