...
class ObsDictRelabelingBuffer(ReplayBuffer):
    ...
    def random_batch(self, batch_size):
        ...
        if num_future_goals > 0:
            ...
            # See https://github.com/vitchyr/vcrl/pull/112 for details.
            next_obs_idxs = (
        ...
        # Kyowoon add this part: relabel dones
        if hasattr(self.env, 'compute_terminals'):
            new_terminals = self.env.compute_terminals(new_next_obs_dict)
            new_terminals = new_terminals.reshape(-1, 1)
        else:  
            new_terminals = self._terminals[indices]
