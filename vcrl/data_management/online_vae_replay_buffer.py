...
from vcrl.data_management.obs_dict_replay_buffer import flatten_dict
# from vcrl.data_management.shared_obs_dict_replay_buffer import \
#     SharedObsDictRelabelingBuffer
from vcrl.data_management.obs_dict_replay_buffer import ObsDictRelabelingBuffer
...
class OnlineVaeRelabelingBuffer(ObsDictRelabelingBuffer):
    def __init__(
        ...
        assert isinstance(self.env, VAEWrappedEnv) or isinstance(self.env, EDLWrappedEnv)
        self.vae = vae
