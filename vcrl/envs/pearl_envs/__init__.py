from vcrl.envs.pearl_envs.ant_normal import AntNormal
from vcrl.envs.pearl_envs.ant_dir import AntDirEnv
from vcrl.envs.pearl_envs.ant_goal import AntGoalEnv
from vcrl.envs.pearl_envs.half_cheetah_dir import HalfCheetahDirEnv
from vcrl.envs.pearl_envs.half_cheetah_vel import HalfCheetahVelEnv
from vcrl.envs.pearl_envs.hopper_rand_params_wrapper import \
    HopperRandParamsWrappedEnv
from vcrl.envs.pearl_envs.humanoid_dir import HumanoidDirEnv
from vcrl.envs.pearl_envs.point_robot import PointEnv, SparsePointEnv
from vcrl.envs.pearl_envs.rand_param_envs.walker2d_rand_params import \
    Walker2DRandParamsEnv
from vcrl.envs.pearl_envs.walker_rand_params_wrapper import \
...
def register_env(name):
    """Registers a env by name for instantiation in vcrl."""
...
#         importlib.import_module('vcrl.envs.pearl_envs.' + module)
