...
vcrl_project_dir = join(os.path.dirname(vcrl.__file__), os.pardir)
LOCAL_LOG_DIR = join(vcrl_project_dir, 'data')
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(vcrl_project_dir, 'scripts', 'run_experiment_from_doodad.py')
    # '/home/user/path/to/vcrl/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/global/home/users/USERNAME/path/to/vcrl/scripts'
...
try:
    from vcrl.launchers.conf_private import *
except ImportError:
