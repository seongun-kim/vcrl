from vcrl.envs.wrappers import StackObservationEnv, RewardWrapperEnv
import vcrl.torch.pytorch_util as ptu
from vcrl.samplers.data_collector.step_collector import MdpStepCollector
from vcrl.samplers.data_collector.path_collector import GoalConditionedPathCollector
from vcrl.torch.networks import ConcatMlp
from vcrl.torch.sac.policies import TanhGaussianPolicy, MakeDeterministic
from vcrl.torch.sac.awac_trainer import AWACTrainer
from vcrl.torch.torch_rl_algorithm import (
    TorchBatchRLAlgorithm,
    TorchOnlineRLAlgorithm,
)

from vcrl.demos.source.mdp_path_loader import MDPPathLoader
from vcrl.visualization.video import save_paths

import torch
from vcrl.visualization.video import save_paths, VideoSaveFunction, RIGVideoSaveFunction
from vcrl.envs.images import Renderer, InsertImageEnv, EnvRenderer
from vcrl.launchers.contextual.util import (
    get_save_video_function,
    get_gym_env,
)

from vcrl.exploration_strategies.base import \
    PolicyWrappedWithExplorationStrategy
from vcrl.exploration_strategies.gaussian_and_epislon import GaussianAndEpsilonStrategy
from vcrl.exploration_strategies.ou_strategy import OUStrategy

import os.path as osp
from vcrl.core import logger
from vcrl.misc.asset_loader import load_local_or_remote_file

from vcrl.data_management.obs_dict_replay_buffer import \
        ObsDictRelabelingBuffer
from vcrl.data_management.wrappers.concat_to_obs_wrapper import \
        ConcatToObsWrapper
from vcrl.envs.reward_mask_wrapper import DiscreteDistribution, RewardMaskWrapper

from functools import partial
import vcrl.samplers.rollout_functions as rf

from vcrl.envs.contextual import ContextualEnv

from vcrl.envs.contextual.goal_conditioned import (
