...
from vcrl.launchers import conf
from vcrl.torch.pytorch_util import set_gpu_mode
import vcrl.pythonplusplus as ppp
...
def run_experiment(
    ...
    :param use_gpu:
    :param snapshot_mode: See vcrl.core.logging
    :param snapshot_gap: See vcrl.core.logging
    ...
    if mode == 'local':
        ...
        dmode = doodad.mode.EC2AutoconfigDocker(
            ...
            # will start just making the sub-directories within vcrl rather
