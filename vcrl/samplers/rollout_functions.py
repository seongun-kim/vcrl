...
def rollout(
    ...
    if render:
        ...
        camera_params = [
            -1, 
            1.3945207996404312,
            0.022804964579085863,
            0.3486005167375966,
            0.2206617361227136,
            -32.768225200038515, 
            141.67935987660226
        ]
        env.env.viewer.cam.trackbodyid = camera_params[0]
        env.env.viewer.cam.distance = camera_params[1]
        env.env.viewer.cam.lookat[0] = camera_params[2]
        env.env.viewer.cam.lookat[1] = camera_params[3]
        env.env.viewer.cam.lookat[2] = camera_params[4]
        env.env.viewer.cam.elevation = camera_params[5]
        env.env.viewer.cam.azimuth = camera_params[6]
